...
WebUI.click(findTestObject('Booking/Booking menu'))

//WebUI.click(findTestObject('Booking/Store Name'))
//
//WebUI.click(findTestObject('Booking/Date Booking'))
//
//WebUI.selectOptionByValue(findTestObject('Booking/Pick Option Value'), '11', true)
//
//WebUI.click(findTestObject('Booking/Time'))
//
//WebUI.setText(findTestObject('Booking/Comment'), 'Sdekd')
//
//WebUI.click(findTestObject('Booking/Book Now'))
