...
WebUI.click(findTestObject('Page_CDG/History Booking'))

WebUI.callTestCase(findTestCase('Main Test Cases/Verify History booking'), [:], FailureHandling.STOP_ON_FAILURE)
